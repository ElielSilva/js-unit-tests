...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('função retorna o objeto correto para o parâmetro "Arya"', () => {
  ...
  it('função retorna o objeto correto para o parâmetro "Brienne"', () => {
  ...
  it('passar um nome que não está na tabela, a função retorna undefined', () => {
    expect(getCharacter('Eliel')).toBeUndefined();
  })
  //});
});
